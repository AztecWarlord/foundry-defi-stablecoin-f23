...
contract DSCEngine is ReentrancyGuard {
    ...
    mapping(address => address priceFeed) private s_priceFeeds; // tokenToPriceFeed
    ...
    * @notice this function will deposit your colllateral, and mint DSC in one transaction
    */
     ...
     * @notice follows CEI
     * @param amountDscToMint The amount of DSC to mint
     * @notice they must have more collateral value than the minimum threshold (1.5x)
     ...
     * @notice You will get a liquidation reward for liquidating a users funds
    ...
    function liquidate(address collateral, address user, uint256 debtToCover)
        ...
        nonReentrant
    {
        // need to check hellth factor of the user
        ...
        // So we are giving the liuidator $110 of WETH for 100 DSC
    ...
    function getAccountCollateralValue(address user) public view returns (uint256 totalCollateralValueInUsd) {
        // loop thirugh each collateral token, get the amount they have deposited, and map it to
        // the price, to the the USD value of that collateral
    ...
    function getUsdValue(address token, uint256 amount) public view returns (uint256) {
        ...
        (, int256 price,,,) = priceFeed.staleCheckLatestRoundData();
        // 1 ETH = $1000
        // The returned valuse from CL will be 1000 * 1e8
