...
contract DSCEngineTest is Test {
    ...
    function setUp() external {
        ...
        // Mint some WETH for the user in the setUp to avoid having to mint in every test
    ...
    function testRevertWithUnapprovedColllateral() public {
    ...
    function testCantLiquidateGoodHealthFactor() public depositedCollateralAndMintedDsc {
        ...
        dsce.liquidate(USER, weth, AMOUNT_TO_MINT);
        vm.stopPrank();
    }
    ...
    modifier liquidated() {
        ...
        dsce.depositCollateralAndMintDsc(weth, AMOUNT_COLLATERAL, AMOUNT_TO_MINT);
        vm.stopPrank();
        int256 ethUsdUpdatedPrice = 18e8; // 1ETH = 18usd
    ...
    function testGetDsc() public {
        ...
        assertEq(address(dscAddress), dsce.getDsc());
    }

    function testMinGetHealthFactor() public {
    ...
    function testGetCollateralValue() public {
        ...
        uint256 expectedCollateralBalance = dsce.getUsdValue(weth, AMOUNT_COLLATERAL);
        assertEq(collateralValue, expectedCollateralBalance);
    }
}
