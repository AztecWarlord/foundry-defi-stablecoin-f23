...
contract Handler is Test {
    ...
    uint256 public constant MAX_DEPOSIT_SIZE = type(uint96).max; // the max size of a uint96
    ...
    function redeemCollateral(uint256 collateralSeed, uint256 amountCollateral) public {
        ...
        // there is a bug, where a user can redeem more collateral than they have
